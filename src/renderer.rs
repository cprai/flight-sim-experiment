...
impl Renderer {
    pub async fn new(
        ...
        // around the terrain it has just read in. Setting the wind later would
        // have no effect at all, which is the one sharp edge of baking.
